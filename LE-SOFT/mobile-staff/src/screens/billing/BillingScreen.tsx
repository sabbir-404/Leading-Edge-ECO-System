...
const makeStyles = (theme: any, ui: any, insets: any) => StyleSheet.create({
  ...
  sectionLabel: {
    ...
    fontSize: ui.isUltraCompact ? ui.font(11) : ui.font(12),
    fontWeight: '800',
    textTransform: 'uppercase',
    letterSpacing: ui.isUltraCompact ? 1 : 1.2,
    marginBottom: ui.spacing(14),
  },
  sectionHeaderRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: ui.spacing(12) },
  showMoreText: { color: theme.accent, fontSize: ui.font(13), fontWeight: '800' },
  helperText: { color: theme.textMuted, fontSize: ui.font(12), fontWeight: '600' },
  compactToggleRow: { marginTop: ui.spacing(8), marginBottom: ui.spacing(4) },
  ...
  inputRow: {
    ...
    paddingHorizontal: ui.isUltraCompact ? ui.spacing(12) : ui.spacing(14),
    borderWidth: 1.5,
    borderColor: theme.border,
    gap: ui.spacing(10),
  },
  input: { flex: 1, color: theme.textPrimary, paddingVertical: ui.spacing(12), fontSize: ui.font(15), fontWeight: '500' },
  inputTopGap: { marginTop: ui.spacing(10) },
  textArea: { minHeight: ui.scale(80), alignItems: 'flex-start' },
  textAreaInput: { textAlignVertical: 'top', paddingVertical: ui.spacing(12) },
  fieldLabel: { color: theme.textSecondary, fontSize: ui.font(12), fontWeight: '700', marginBottom: ui.spacing(6), textTransform: 'uppercase', letterSpacing: 0.5 },

  customerTagRow: { flexDirection: 'row', alignItems: 'center', gap: ui.spacing(8), marginTop: ui.spacing(10) },
  customerTag: { fontSize: ui.font(13), fontWeight: '700' },

  searchRow: { flexDirection: 'row', gap: ui.isUltraCompact ? ui.spacing(8) : ui.spacing(12), alignItems: 'center' },
  scanBtn: {
  ...
  inlineBtnText: { color: theme.accent, fontSize: ui.font(13), fontWeight: '800' },
  ...
  cartItem: { paddingVertical: ui.spacing(12), borderBottomWidth: 1, borderBottomColor: theme.border },
  cartTopRow: { flexDirection: 'row', alignItems: 'center', gap: ui.spacing(10), marginBottom: ui.spacing(8) },
  cartName: { color: theme.textPrimary, fontWeight: '800', fontSize: ui.font(15) },
  cartMeta: { color: theme.textMuted, fontSize: ui.font(12), marginTop: ui.spacing(3) },
  qtyRow: { flexDirection: 'row', alignItems: 'center', gap: ui.spacing(10), marginTop: ui.spacing(10) },
  qBtn: {
  ...
  qtyInput: {
    minWidth: ui.isUltraCompact ? ui.scale(48) : ui.scale(54),
    textAlign: 'center',
    color: theme.textPrimary,
    fontWeight: '800',
    backgroundColor: theme.bgInput,
  ...
  lineTotalText: { color: theme.accent, fontSize: ui.font(14), fontWeight: '900' },

  priceControlRow: { flexDirection: 'row', gap: ui.spacing(10), marginTop: ui.spacing(10) },
  smallInputWrap: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: ui.spacing(8),
  ...
  splitRow: { flexDirection: ui.isUltraCompact ? 'column' : 'row', gap: ui.spacing(10), marginTop: ui.spacing(12) },
  splitCol: { flex: 1 },

  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: ui.spacing(6) },
  summaryKey: { color: theme.textSecondary, fontSize: ui.font(14), fontWeight: '600' },
  summaryVal: { color: theme.textPrimary, fontSize: ui.font(14), fontWeight: '700', textAlign: 'right' },
  summaryTotalRow: { borderTopWidth: 2, borderTopColor: theme.accent, marginTop: ui.spacing(10), paddingTop: ui.spacing(12) },
  summaryTotalKey: { color: theme.textPrimary, fontSize: ui.font(16), fontWeight: '900', letterSpacing: 0.2 },
  summaryTotalVal: { color: theme.success, fontSize: ui.font(18), fontWeight: '900' },
  wordsText: { color: theme.textMuted, fontSize: ui.font(12), marginTop: ui.spacing(10), lineHeight: ui.font(18), fontWeight: '600' },
  ...
  footer: {
    ...
    alignItems: 'center',
    paddingHorizontal: ui.contentPadding,
    paddingTop: ui.spacing(16),
    backgroundColor: theme.bgCard,
    borderTopWidth: 1.5,
    borderTopColor: theme.border,
    paddingBottom: (insets.bottom > 0 ? insets.bottom : ui.spacing(12)) + ui.spacing(10),
    gap: ui.spacing(16),
  },
  totalLabel: { color: theme.textSecondary, fontSize: ui.font(13), fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5 },
  totalValue: { fontSize: ui.font(28, 24, 32), fontWeight: '900', color: theme.textPrimary },
  saveBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: ui.spacing(10),
    borderRadius: ui.radius(16),
    paddingVertical: ui.isUltraCompact ? ui.spacing(14) : ui.spacing(16),
    paddingHorizontal: ui.isUltraCompact ? ui.spacing(20) : ui.spacing(28),
    shadowColor: theme.success,
    shadowOpacity: 0.25,
    shadowRadius: 12,
    shadowOffset: { width: 0, height: 4 },
  },
  saveBtnText: { color: '#fff', fontWeight: '900', fontSize: ui.font(17), letterSpacing: 0.2 },
