...
const UserCreate: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // @ts-ignore
            const res = await window.electron.createUser({ ...formData, groupId: formData.groupId ? Number(formData.groupId) : null, requestingUserRole: isSuperAdmin ? 'superadmin' : userRole, requestingUserName: userName });
            if (!res?.success) {
