export interface ElectronAPI {
    ...
    deleteMakeOrder: (id: number | string) => Promise<any>;
    ...
    makePickAndUploadDrawing?: (data: { orderId: number; itemId?: number }) => Promise<any>;
    makePickAndUploadStagePhoto?: (data: { orderId: number }) => Promise<any>;
    ...
    createMakeOrder: (order: any) => Promise<any>;
    updateMakeOrderStatus: (data: any) => Promise<any>;
    getMakeOrderUpdates: (orderId: number | string) => Promise<any[]>;
    deleteMakeOrder: (id: number | string) => Promise<any>;
    makeDeleteOrder: (orderId: number | string) => Promise<any>;
    getMakeFurnitureNames: () => Promise<string[]>;
    makeUploadPdf: (data: any) => Promise<any>;
    makeGetPdfUrls: (orderId: number | string) => Promise<any[]>;
    makeDeletePdf: (data: any) => Promise<any>;
    makeDownloadPdf: (data: any) => Promise<any>;
    makeUploadItemPdf?: (data: { orderId: number | string; itemId: number | string; filePath?: string }) => Promise<any>;
    makeDeleteItemPdf?: (data: { itemId: number | string; storagePath: string }) => Promise<any>;
    makePickAndUploadDrawing?: (data: { orderId: number | string; itemId?: number | string }) => Promise<any>;
    makePickAndUploadStagePhoto?: (data: { orderId: number | string }) => Promise<any>;
    makePickAndUploadInvoiceAttachment?: (data?: { orderId?: number | string }) => Promise<any>;
    makeUploadInvoiceAttachmentBuffer?: (data: { fileName: string; fileBase64: string; orderId?: number | string; itemId?: number | string }) => Promise<any>;
    makeGetOrderParts: (orderId: number | string) => Promise<any[]>;
    makeUpsertPart: (part: any) => Promise<any>;
    makeDeletePart: (partId: number | string) => Promise<any>;
    makeAlterOrder: (data: any) => Promise<any>;
    makeGetAlterationLog: (orderId: number | string) => Promise<any[]>;
    getSalesmen: () => Promise<any[]>;
    approveMakeOrder: (data: { orderId: number | string, approvedBy?: string, notes?: string, override?: any }) => Promise<any>;
    setMakeOrderPrice: (data: { orderId: number | string, customPrice: number, updatedBy: string }) => Promise<any>;
    markCustomizationPaid: (data: { orderId: number | string, updatedBy: string }) => Promise<any>;
    makeGetDashboardStats: () => Promise<any>;
    ...
    makeDeleteSpec: (id: number | string) => Promise<any>;
    makeSaveSize: (size: any) => Promise<any>;
    makeDeleteSize: (id: number | string) => Promise<any>;
    makeSaveColor: (color: any) => Promise<any>;
    makeDeleteColor: (id: number | string) => Promise<any>;
    makeDeleteCategory: (id: number | string) => Promise<any>;
    makeGetGlobalAttributes?: () => Promise<{ categories: any[]; specs: any[]; sizes: any[]; colors: any[] }>;
    makeSaveGlobalAttribute?: (data: any) => Promise<any>;
    makeAssignProductAttributes?: (data: { productId: number | string; specIds?: (number | string)[]; sizeIds?: (number | string)[]; colorIds?: (number | string)[] }) => Promise<any>;
    makeGetProductPurchaseHistory?: (productId: number | string) => Promise<any>;
    makeGetOrderItems: (orderId: number | string) => Promise<any[]>;
