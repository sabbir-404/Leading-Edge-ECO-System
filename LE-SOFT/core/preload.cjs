...
import_electron.contextBridge.exposeInMainWorld("electron", {
  ...
  updateStockGroup: (id, group) => import_electron.ipcRenderer.invoke("update-stock-group", id, group),
  ...
  // Products
  getProducts: (opts) => import_electron.ipcRenderer.invoke("get-products", opts),
  getProduct: (id) => import_electron.ipcRenderer.invoke("get-product", id),
  getProductLedgerDetail: (id) => import_electron.ipcRenderer.invoke("get-product-ledger-detail", id),
  getProductRequisitionSummary: (productId, filters) => import_electron.ipcRenderer.invoke("get-product-requisition-summary", productId, filters),
  ...
  deleteProduct: (id, performedByName, userRole) => import_electron.ipcRenderer.invoke("delete-product", id, performedByName, userRole),
  requestProductDeletion: (id, performedByName, notes) => import_electron.ipcRenderer.invoke("request-product-deletion", id, performedByName, notes),
  approveProductDeletion: (id, performedByName) => import_electron.ipcRenderer.invoke("approve-product-deletion", id, performedByName),
  rejectProductDeletion: (id) => import_electron.ipcRenderer.invoke("reject-product-deletion", id),
  ...
  getProductOrigins: () => import_electron.ipcRenderer.invoke("get-product-origins"),
  saveProductOrigin: (origin) => import_electron.ipcRenderer.invoke("save-product-origin", origin),
  deleteProductOrigin: (id) => import_electron.ipcRenderer.invoke("delete-product-origin", id),
  getProductAttributes: () => import_electron.ipcRenderer.invoke("get-product-attributes"),
  saveProductAttribute: (attribute) => import_electron.ipcRenderer.invoke("save-product-attribute", attribute),
  deleteProductAttribute: (id) => import_electron.ipcRenderer.invoke("delete-product-attribute", id),
  getDamagedGoods: () => import_electron.ipcRenderer.invoke("get-damaged-goods"),
  createDamagedGoods: (payload) => import_electron.ipcRenderer.invoke("create-damaged-goods", payload),
  updateDamagedGoodsStatus: (id, status, payload) => import_electron.ipcRenderer.invoke("update-damaged-goods-status", id, status, payload),
  // Godowns / Warehouses
  ...
  makeDeleteSpec: (id) => import_electron.ipcRenderer.invoke("make-delete-spec", id),
  makeSaveSize: (size) => import_electron.ipcRenderer.invoke("make-save-size", size),
  ...
  hrmGetHolidays: () => import_electron.ipcRenderer.invoke("hrm-get-holidays"),
  hrmUpsertHoliday: (data) => import_electron.ipcRenderer.invoke("hrm-upsert-holiday", data),
  hrmDeleteHoliday: (id) => import_electron.ipcRenderer.invoke("hrm-delete-holiday", id),
  // ─── CRM MODULE ───
  ...
  // ─── PAYMENT METHODS ───
  getPaymentMethods: () => import_electron.ipcRenderer.invoke("get-payment-methods"),
  ...
  approvePurchaseRequisition: (id, status, notes, performedByName) => import_electron.ipcRenderer.invoke("approve-purchase-requisition", id, status, notes, performedByName),
  submitPurchaseEstimates: (id, quotes, performedByName) => import_electron.ipcRenderer.invoke("submit-purchase-estimates", id, quotes, performedByName),
  ...
  auditReviewPurchaseRequisition: (id, status, notes, performedByName) => import_electron.ipcRenderer.invoke("audit-review-purchase-requisition", id, status, notes, performedByName),
  directorReviewPurchaseRequisition: (id, status, notes, performedByName) => import_electron.ipcRenderer.invoke("director-review-purchase-requisition", id, status, notes, performedByName),
  purchasePurchaseRequisition: (id, payload) => import_electron.ipcRenderer.invoke("purchase-purchase-requisition", id, payload),
  receivePurchaseRequisition: (id, performedByName) => import_electron.ipcRenderer.invoke("receive-purchase-requisition", id, performedByName),
  completePurchaseRequisition: (id, performedByName) => import_electron.ipcRenderer.invoke("complete-purchase-requisition", id, performedByName),
  deletePurchaseRequisition: (id, performedByName) => import_electron.ipcRenderer.invoke("delete-purchase-requisition", id, performedByName),
