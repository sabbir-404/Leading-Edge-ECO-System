...
contextBridge.exposeInMainWorld('electron', {
    ...
    deleteProduct: (id: number, performedByName?: string, userRole?: string) => ipcRenderer.invoke('delete-product', id, performedByName, userRole),
    requestProductDeletion: (id: number, performedByName: string, notes: string) => ipcRenderer.invoke('request-product-deletion', id, performedByName, notes),
    approveProductDeletion: (id: number, performedByName: string) => ipcRenderer.invoke('approve-product-deletion', id, performedByName),
    rejectProductDeletion: (id: number) => ipcRenderer.invoke('reject-product-deletion', id),
    ...
    deleteBillingCustomer: (id: number) => ipcRenderer.invoke('delete-billing-customer', id),
    createBill: (bill: any) => ipcRenderer.invoke('create-bill', bill),
    getBills: (opts?: any) => ipcRenderer.invoke('get-bills', opts),
    ...
    getCustomerLedgerList: (opts?: any) => ipcRenderer.invoke('get-customer-ledger-list', opts),
